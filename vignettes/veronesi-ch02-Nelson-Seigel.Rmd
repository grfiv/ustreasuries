---
title: "Veronesi Chapter 2 Appendix: Nelson Seigel/Svensson"
...
In this example, I use the FedInvest data of 400 daily bond prices as the data to model the yield curve. It turns out that Nelson-Seigel is a lot worse than is shown in the book, at least on this data for the dates I chose.   
...
## Download CMT yield-curve data for comparison
...
# see Veronesi ch2 p68 eqn 2.53
NSrates <- function(parameters, maturities=c(1/12, 3/12, 6/12, 1, 2, 3, 5, 7, 10, 20, 30)) {
    #
    # use the Nelson-Seigel formula to model the CMT rates.
    #
